...
import com.example.jonesq.meh3.utils.PREF_EXTRA_NOTIFICATION_IS_ALARM_ON
...
class BroadcastReceiver_Notifications_Service_Startup : BroadcastReceiver() {
    override fun onReceive(pContext: Context, pIntent: Intent) {
        ...
        val vAlarmIsOn = vSharedPreferences.getBoolean(PREF_EXTRA_NOTIFICATION_IS_ALARM_ON, false)
